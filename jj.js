...
function ensureAIChatLabel(btn){ if(!btn) return; const t=(btn.textContent||"").trim(); if(!t) btn.textContent="AI CHAT"; btn.setAttribute("aria-label","AI CHAT"); btn.setAttribute("role","button"); }

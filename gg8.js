...
/* colectare referințe dintr-un wrapper */
...
/* *** FIX principal flash: aplic stare no-image doar LOCAL pe wrapperul curent *** */
...
/* stop media când schimb întrebarea */
...
function ensureAIPop(){
  ...
  async function showFinal(){
    ...
    // pregătește lista wrong pentru „refă doar greșitele”
    try{
      const pool=[];
      answersSnap.forEach(doc=>{
        const d=doc.data();
  ...
  /* Dacă intrăm direct în ecranul final din progres salvat, calculez și barele/procentele. */

...
async function updateInPlace(idx,{resetSelections=false}={}){
  ...
  // restaurare răspuns doar dacă:
  // - nu e wrong-mode, SAU
  // - e wrong-mode DAR răspunsul a fost dat în sesiunea curentă (answeredAtMs >= WRONG_STARTED_AT_MS)
  try{
...
async function showFinal(){
  ...
  // PREP lista wrong pentru start rapid + prefetch
  try{
